  ...
  <div class="blockchain-container">
      ...
      <div class="node-selector-bar">
          <div class="selector-left">
              ...
              <button
                  ...
                  <div class="node-blocks">区块{{ node.blockCount }}</div>
              </button>
      ...
      <div class="controls">
        ...
        <div class="auto-refresh">
          <label>
            <input type="checkbox" v-model="autoRefresh">Auto Refresh(2s)</input>
          </label>
        </div>
      </div>
...
try {
  ...
  console.log('获取区块数据+++++++++++++++++:', response.data);
...
.node-btn.active {
  background: linear-gradient(135deg, #667eea 0%, #754ba2 100%);
  border-color: #667eea;
  color: white;
